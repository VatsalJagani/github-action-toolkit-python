...
_event_payload_instance = EventPayload()
...
def event_payload() -> dict[str, Any]:
    ...
    :returns: dictionary of event payload
    """
    return _event_payload_instance.get_payload()


# Add a cache_clear method for backward compatibility with tests
def _clear_event_payload_cache() -> None:
    """Clear both the lru_cache and instance cache."""
    _event_payload_instance.clear_cache()


# Monkey-patch the cache_clear method onto event_payload function
event_payload.cache_clear = _clear_event_payload_cache  # type: ignore  # pyright: ignore[reportFunctionMemberAccess]
...
def get_event_name() -> str:
    ...
    :returns: event name (e.g., 'push', 'pull_request', 'issue_comment')
    """
    return _event_payload_instance.get_event_name()
...
def get_typed_event() -> PushEvent | PullRequestEvent | IssueCommentEvent | WorkflowRunEvent | None:
    ...
    :returns: typed event model or None if event type is not supported
    """
    return _event_payload_instance.get_typed_event()
...
def is_pr() -> bool:
    ...
    :returns: True if the event is a pull request event, False otherwise
    """
    return _event_payload_instance.is_pr()
...
def get_pr_number() -> int | None:
    ...
    :returns: PR number or None if not a PR event
    """
    return _event_payload_instance.get_pr_number()
...
def head_ref() -> str | None:
    ...
    :returns: head reference or None
    """
    return _event_payload_instance.head_ref()
...
def base_ref() -> str | None:
    ...
    :returns: base reference or None
    """
    return _event_payload_instance.base_ref()
...
def get_changed_files() -> list[str]:
    ...
    :returns: list of changed file paths
    """
    return _event_payload_instance.get_changed_files()
...
def get_labels() -> list[str]:
    ...
    :returns: list of label names
    """
    return _event_payload_instance.get_labels()
